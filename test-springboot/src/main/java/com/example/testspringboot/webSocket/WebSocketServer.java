...
import com.example.testspringboot.entity.bo.NoticeWebsocketResp;
...
public class WebSocketServer {
    ...
    public static boolean isServerClose() {
        if (WebSocketServer.clients.values().isEmpty()) {
            log.info("已断开");
            return true;
        }else {
            log.info("已连接");
     ...
     * @param noticeInfo
     */
    public static void sendMessage(String noticeInfo){
